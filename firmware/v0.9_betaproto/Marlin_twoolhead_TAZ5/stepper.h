...
#elif EXTRUDERS > 1
  #ifdef PARALLEL_PRINTING
   #define WRITE_E_STEP(v) { WRITE(E0_STEP_PIN, v); WRITE(E1_STEP_PIN, v); }
   #define NORM_E_DIR() { WRITE(E0_DIR_PIN, !INVERT_E0_DIR); WRITE(E1_DIR_PIN, !INVERT_E1_DIR); }
   #define REV_E_DIR() { WRITE(E0_DIR_PIN, INVERT_E0_DIR); WRITE(E1_DIR_PIN, INVERT_E1_DIR); }
  #endif
