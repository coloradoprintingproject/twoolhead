...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "TWAZ"
...
const bool Y_MAX_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. USED FOR EMI ATTENUATION!
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 138
