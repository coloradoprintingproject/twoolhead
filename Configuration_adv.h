...
#define CONTROLLERFAN_SPEED_FULL 255  // == full speed
...
//Enable this if you have 2 extruders set up to print in parallel
#define PARALLEL_PRINTING
...
#else
#define MAX_STEP_FREQUENCY 40000 // Max step frequency for LulzBot TAZ
#endif
...
#define DIGIPOT_MOTOR_CURRENT {175,175,200,200,200} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
